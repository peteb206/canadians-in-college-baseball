...
assert (player.id == '2658233') & (player.last_name == 'Dykstra') & (player.OPS == 0.945)
...
player.add_stats(school.stats_page)
assert (player.id == '2812025') & (player.last_name == 'Bucovetsky') & (player.HR == 4)
...
player.add_stats(school.stats_page)
assert (player.id == '2337388') & (player.last_name == "D'Angela") & (player.IP == 38.1)
...
player.add_stats(school.stats_page)
assert (player.id == 'hiloyamamoto4wu6') & (player.last_name == 'Yamamoto') & (player.RBI == 2)
...
player.add_stats(school.stats_page)
assert (player.id == 'fabianromero1op0') & (player.last_name == 'Romero') & (player.G == 47)
...
player: Player = players[0]
player.add_stats(school.stats_page)
assert (player.id == 'jasonzhang7wgu') & (player.last_name == 'Zhang') & (player.AB == 117)
...
player.add_stats(school.stats_page)
assert (player.id == 'brockrindlisbacher1s1s') & (player.last_name == 'Rindlisbacher') & (player.R == 9)
